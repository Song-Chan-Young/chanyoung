...
@Controller
@RequestMapping( value = "/contact/notice" )
public class ContactNoticeController {

	private final static Logger logger = LoggerFactory.getLogger(ContactNoticeController.class);

	@Autowired
	private ContactNoticeService service;

	@RequestMapping( value = "/update", method = RequestMethod.POST )
	public void update( ContactNoticeDTO dto, HttpSession session, PrintWriter out ) {
	...
	public String updateForm( String board_no, Model model ) {
		...
		return "/contact/notice/update_form";//jsp file name
	}//updateForm

	@RequestMapping( value = "/delete", method = RequestMethod.GET )
	public void delete( ContactNoticeDTO dto, HttpSession session, PrintWriter out ) {
		MemberDTO mDto = (MemberDTO) session.getAttribute("login_info");
		dto.setMno( mDto.getMno() );
	...
	public String detail( String board_no, Model model ) {
		...
		dto = service.detail( board_no );
		model.addAttribute("detail_dto", dto);
		return "/contact/notice/detail";//jsp file name
	}//detail

	@RequestMapping( value = "/write", method = RequestMethod.POST )
	public void write( ContactNoticeDTO dto, HttpSession session, PrintWriter out ) {
		MemberDTO mDto = (MemberDTO) session.getAttribute("login_info");
		dto.setMno( mDto.getMno() );
	...
	public String writeForm() {
		return "/contact/notice/write_form";//jsp file name
	}//writeForm
	...
	public String list( Model model, String userWantPage, SearchDTO dto ) {
		...
		return "/contact/notice/list";//jsp file name
