...
public class OrderMainDTO {
	...
	private String str_cart_no;
	private String [] arr_cart_no;
	...
	public String getStr_cart_no() {
		return str_cart_no;
	}
	public void setStr_cart_no(String str_cart_no) {
		this.str_cart_no = str_cart_no;
	}
	public String[] getArr_cart_no() {
		return arr_cart_no;
	}
	public void setArr_cart_no(String[] arr_cart_no) {
		this.arr_cart_no = arr_cart_no;
	}
